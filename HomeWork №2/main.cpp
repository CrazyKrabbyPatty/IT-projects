...
int main() {
    ...
    while (window.isOpen()) {
        ...
        drawGraphY(window, [](float x) { return x; }, -10, 10, 50, 50, sf::Color::Blue);
        //drawGraph(window, [](float x) { return x; }, -10, 10, 30, 100, sf::Color::Blue);

        // 5 _   Отрисовка графика x = 3 (Замените на ваш график)
        drawGraphX(window, [](float y) { return 3; }, -10, 10, 50, 50, sf::Color::Red);
        //drawGraph2(window, [](float y) { return 3; }, -10, 10, 30, 100, sf::Color::Red);
